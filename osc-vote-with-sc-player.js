...
var removeAccents = function(string){return string.replace(/[^A-Za-z0-9\[\] ]/g,function(a){return Latinise.latin_map[a]||a})};
var cid = 'client_id=8f5aa8a7f1d660714d9dab510be7d2d9'
var sc = function(stuff) {
	return 'https://api.soundcloud.com/' + stuff + (stuff.indexOf('?') >= 0 ? '&' : '?') + cid
}
